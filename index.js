...
export default function DebtTracker() {
  ...
  return (
    <div style={{padding:'20px',fontFamily:'Arial',background:'#f3f4f6',minHeight:'100vh'}}>
      <div style={{maxWidth:'700px',margin:'0 auto'}}>
        <div style={{background:'white',padding:'24px',borderRadius:'20px',marginBottom:'20px'}}>
          ...
          <div style={{marginTop:'20px'}}>
            ...
            <div style={{background:'#ddd',height:'14px',borderRadius:'20px',overflow:'hidden'}}>
              <div
                style={{
                  width:`${progress}%`,
                  background:'black',
        ...
        {sections.map((section,index)=>(
          <div key={index} style={{background:'white',padding:'24px',borderRadius:'20px',marginBottom:'20px'}}>
            <h2>{section.title}</h2>
